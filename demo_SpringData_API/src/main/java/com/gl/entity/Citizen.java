...
public class Citizen {
	...
	public Citizen(int id, LocalDate dob, String name, String address, String emailId, String gender, String mobileNo) {
		super();
		this.id = id;
		this.dob = dob;
		this.name = name;
	...
	public String toString() {
		return "Citizen [id=" + id + ", dob=" + dob + ", name=" + name + ", address=" + address + ", emailId=" + emailId
